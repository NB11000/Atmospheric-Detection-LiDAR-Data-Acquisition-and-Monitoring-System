namespace ConsoleApp1.Models
{
    ...
    public class LidarAlgorithmConfig
    {
        ...
        /// <summary>Fernald 远端边界距离 (m)，边界处假设 α_a ≈ 0（洁净大气）</summary>
        public double FernaldBoundaryDistance_m { get; set; } = 3000.0;

        /// <summary>激光波长 (nm)，用于 Angstrom 修正</summary>
        ...
        /// <summary>暗电流采样点数（从帧尾部"无激光时段"取均值），0 表示不扣除</summary>
        public int DarkCurrentSampleCount { get; set; } = 0;

        /// <summary>采样率 (Hz)，用于距离门宽度计算：Δr = c / (2 × SampleRateHz)</summary>
        public double SampleRateHz { get; set; } = 20_000_000.0;

        /// <summary>近场盲区距离 (m)，盲区内电压置零不参与反演</summary>
